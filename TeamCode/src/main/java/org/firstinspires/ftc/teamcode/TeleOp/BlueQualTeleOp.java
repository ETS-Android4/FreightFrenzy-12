...
public class BlueQualTeleOp extends LinearOpMode {
    ...
    public static double p = 0.0003, targetX = 115, yPow = 0.8, yConst = -0.015, xPow = 0.6, maximumHubWidth = 145, imuP = 0.5;

    public static double durationMilli = 1800, rampP = -0.0006, rampF = -0.2;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Sequence strafeToHub = new Sequence(() -> {
            try {
                ...
                while (x == -1 && !manual) {
                    System.out.println("The center is " + x);
        ...
        while(!isStopRequested()) {
            ...
            try {
                ...
                invert = invert < 0 ? 1 : -1;
                double power = invert * 0.8 * (Math.abs(tempHeading - tempTarget) > Math.PI ? (
