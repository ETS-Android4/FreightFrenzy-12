...
public class FreightSimpleRedDuckWare extends LinearOpMode {
    ...
    public static double OPEN = 0, CLOSED = 0, first = 22, back = 14, forward1 = 12, leaveSpinner = 8, front = 20, forward2 = 14, strafe = 54; //ALL VALUES NEED TO BE TUNED
